...
#define RCC_CFG_REG_ADDR		(RCC_BASE_ADDRESS + RCC_CFG_REG_OFFSET)

#define GPIOA_BASE_ADDR			0x40020000UL

int main(void)
{
	uint32_t *pRccCfgReg = (uint32_t*) RCC_CFG_REG_ADDR;

	*pRccCfgReg &= ~(0x3 << 21);

	//1. Configure the RCC_CFGR MCO1 bit fields to select HSI as clock source
	*pRccCfgReg &= ~(0x3 << 21); //clear 21 and 22 bit positions
